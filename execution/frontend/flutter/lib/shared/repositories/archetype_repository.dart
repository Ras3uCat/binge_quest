...
class ArchetypeRepository {
  ...
  static Future<List<Archetype>> fetchAllArchetypes() async {
    ...
    return (response as List)
        .map((json) => Archetype.fromJson(json))
        .toList();
  }
  ...
  static Future<List<UserArchetype>> fetchUserCurrentScores(
    String userId,
  ) async {
